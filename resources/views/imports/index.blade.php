    ...
    <section class="split-panel">
        <article class="dashboard-panel">
            ...
            <form class="settings-form" method="POST" action="{{ route('imports.employees') }}" enctype="multipart/form-data">
                ...
                @endif
                <div class="import-help"><span>Required: name_en, email, and password. Optional: emirates_id. No password confirmation column is required. Use role name or slug for role assignment. Employee codes are generated automatically.</span><a class="btn btn-outline btn-sm" href="{{ route('imports.template', 'employees') }}"><x-dashboard.icon name="download" /> Download Template</a></div>
